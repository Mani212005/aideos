    ...
    shots: [
      {
        ...
        blocks: [{ c: "TextReveal", text: "Why Mars Has No Liquid Water" }],
      },
      {
        id: "shot-2",
        dur: 6,
        ...
        blocks: [{ c: "TextReveal", text: "Valid headline" }],
      },
    ],
  };
    ...
    shots: [
      {
        ...
        blocks: [{ c: "TextReveal", text: "Mars Oceans Lost" }],
      },
      {
        id: "shot-2",
        dur: 5,
        ...
        blocks: [{ c: "TextReveal", text: "Low Pressure Regimes" }],
      },
      {
        id: "shot-3",
        dur: 5,
        ...
        metaphor: "liquid-bucket",
        blocks: [{ c: "TextReveal", text: "Triple Point Below Surface" }],
      },
      {
        id: "shot-4",
        dur: 5,
        ...
        move: "pan",
        visualDirection: "Interleaved text beat",
        blocks: [{ c: "TextReveal", text: "Direct Sublimation" }],
      },
      {
        id: "shot-5",
        dur: 5,
        ...
        metaphor: "liquid-bucket",
        blocks: [{ c: "TextReveal", text: "Subsurface Ice Sheets" }],
      },
    ],
  };
    ...
    shots: [
      {
        ...
        blocks: [{ c: "TextReveal", text: "Compute Tradeoff" }],
      },
      {
        id: "shot-2",
        dur: 6,
        ...
        metaphor: "balance-scale",
        blocks: [{ c: "TextReveal", text: "Memory Tradeoff" }],
      },
    ],
  };
    ...
    shots: [
      {
        ...
        metaphor: "liquid-bucket",
        blocks: [{ c: "TextReveal", text: "Mars shot 1" }],
      },
      {
        id: "shot-2",
        dur: 5,
        ...
        blocks: [{ c: "TextReveal", text: "Mars shot 2" }],
      },
      {
        id: "shot-3",
        dur: 5,
        ...
        metaphor: "liquid-bucket",
        blocks: [{ c: "TextReveal", text: "Mars shot 3" }],
      },
      {
        id: "shot-4",
        dur: 5,
        ...
        blocks: [{ c: "TextReveal", text: "Mars shot 4" }],
      },
      {
        id: "shot-5",
        dur: 5,
        ...
        metaphor: "liquid-bucket",
        blocks: [{ c: "TextReveal", text: "Mars shot 5" }],
      },
    ],
  };
  ...
  const templateFilm: Film = {
    ...
    shots: [
      ...
      },
      {
        ...
        blocks: [{ c: "TextReveal", text: "Valid Text" }],
      },
    ],
  };
