  ...
  "shots": [
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "body": "Single prompt in, single answer out. Fails immediately in production.",
          "state": "active"
        },
        {
          "c": "IconLabel",
          "text": "GRAPH ENGINEERING · AGENT COORDINATION"
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "IconLabel",
          "text": "ROOT CAUSE ANALYSIS · SYSTEM COLLAPSE"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "Card",
          "title": "The 4-Step Cycle",
          "body": "A single agent is not a forward line. It is a continuous re-evaluation loop.",
          "state": "active"
        }
      ]
    },
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "Card",
          "title": "Typed State Object",
          "body": "Stores task spec, plan checkpoints, error registers, and partial payloads.",
          "state": "active"
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "IconLabel",
          "text": "DETERMINISTIC ROUTING · ZERO HALLUCINATION"
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "body": "Persisting state per step allows instant rewind and resumed execution.",
          "state": "active"
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "c": "Kicker",
          "text": "03 · MULTI-AGENT ARCHITECTURE"
        },
        {
          "c": "TextReveal",
          "text": "The Supervisor",
        ...
        {
          "c": "IconLabel",
          "text": "SUPERVISOR PATTERN · ONE BRAIN MANY HANDS"
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "Card",
          "title": "Map-Reduce Reducer",
          "body": "Dispatches N worker agents and aggregates into a single merged record.",
          "state": "active"
        }
      ]
    },
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "Card",
          "title": "Sub-Supervisors",
          "body": "Nested supervisory trees scale cleanly to dozens of autonomous agents.",
          "state": "active"
        }
      ]
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "IconLabel",
          "text": "GUARDRAILS · DETERMINISTIC ITERATION CAPS"
        }
      ]
    },
    {
      ...
      "blocks": [
        {
          "c": "Kicker",
          "text": "04 · PRODUCTION OBSERVABILITY"
        },
        {
          "c": "TextReveal",
          "text": "Cost & Debugging",
        ...
        },
        {
          ...
          "body": "Record inputs, outputs, and diffs on every step for deterministic debugging.",
          "state": "active"
        }
      ]
    },
    ...
    },
    {
      ...
      "blocks": [
        ...
        {
          "c": "Card",
          "title": "Master The Coordination",
          "body": "The prompt is just the worker. The graph is the organization.",
          "state": "active"
        },
        {
          "c": "IconLabel",
          "text": "GRAPH ENGINEERING · SHIPPED & DELIVERED"
        }
      ]
    }
  ],
