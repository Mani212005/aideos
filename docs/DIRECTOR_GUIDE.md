...
You have complete creative autonomy. The browser canvas is your viewport; the declarative screenplay ([`film.json`](file:///Users/manijoshi/firstmate/projects/aideos/public/film.json)) is your director's cut.
...
- **Cinematic B-Roll**: Use photoreal GPU footage ([`AnalogyInset`](file:///Users/manijoshi/firstmate/projects/aideos/src/dl/devices.tsx) with `needsFootage`) for visceral real-world metaphors, tactile machinery, and atmospheric depth.
...
While your artistic choices are completely free, your screenplay must respect the fundamental cinematic pacing invariants defined in [`src/dl/schema.ts`](file:///Users/manijoshi/firstmate/projects/aideos/src/dl/schema.ts):
...
- **Schema & Invariants**: See [`src/dl/schema.ts`](file:///Users/manijoshi/firstmate/projects/aideos/src/dl/schema.ts) for full type definitions and runsheet rules.
- **Visual Component Library**: Inspect [`src/dl/devices.tsx`](file:///Users/manijoshi/firstmate/projects/aideos/src/dl/devices.tsx) and [`src/dl/metaphors/MetaphorViewer.tsx`](file:///Users/manijoshi/firstmate/projects/aideos/src/dl/metaphors/MetaphorViewer.tsx) for available visual blocks.
